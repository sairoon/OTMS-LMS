                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                <label class="rdiobox" for="rdio-primary-unchecked">
                                    <input name="user_type" value="1" checked type="radio" class="radio-primary" id="rdio-primary-unchecked">
                                    <span>Admin</span>
                                </label>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <label class="rdiobox" for="rdio-secondary-unchecked">
                                    <input name="user_type" value="2" type="radio" class="radio-primary" id="rdio-secondary-unchecked">
                                    <span>Teacher</span>
                                </label>
                            </div>
                        </div>
